...
const loadCartItems = () => {
    ...
    cart.forEach(cartItem => {
        ...
        <div class="cart-item-container">
                ...
                <div class="cart-item-details">
                    ...
                    <span class="delete-quantity-link-${product.id} link-primary">
                        Delete
                    </span>
                    </div>
                </div>
    ...
    cart.forEach(cartItem => {
        document.querySelector(`.delete-quantity-link-${cartItem.productId}`)
        .addEventListener('click', () => {
            deleteFromCart(cartItem.productId)
            loadCartItems()
        })
    })
    }
